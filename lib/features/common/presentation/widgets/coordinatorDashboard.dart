      ...
      child: Column(
        ...
        children: [
          ...
          DashboardCard(
            ...
            imageAsset: 'images/c4.svg',
            description: 'Check the list of volunteers available to assist with tasks.',
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) =>  ViewHelpersPage())),
          ),
          const SizedBox(height: 12),
          DashboardCard(
            icon: Icons.verified,
            ...
            imageAsset: 'images/c3.svg',
            description: 'Review and approve tasks once they are completed by volunteers.',
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => VerifyTasksPage())),
          ),
          const SizedBox(height: 12),
          DashboardCard(
            icon: Icons.request_page,
            ...
            imageAsset: 'images/c5.svg',
            description: 'Submit or manage requests for essential relief resources.',
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => ResourceRequestPage())),
          ),
          const SizedBox(height: 12),
          DashboardCard(
            icon: Icons.food_bank_rounded,
            ...
            imageAsset: 'images/c6.svg',
            description: 'Browse available resources and track their distribution.',
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) =>  ViewResourcesPage())),
          ),
          const SizedBox(height: 12),
          DashboardCard(
            icon: Icons.question_answer_rounded,
            ...
            imageAsset: 'images/c7.svg',
            description: 'Monitor and manage responses from donors and volunteers to resource requests.',
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) =>  ResourceResponsesPage())),
          ),
          const SizedBox(height: 16),
        ],
      ),
