...
class _MyTasksPageState extends State<MyTasksPage> {
  ...
  //
  //                   ElevatedButton.icon(
  //                     // Style the button to match your primary color scheme
  ...
  //
  //                         // Create the content widget (Image or Icon)
  ...
  //                         }
  //
  //                         // Use Stack to layer the content and the dismiss button
  //                         return Stack(
  //                           children: [
  //                             SizedBox(
  //                               width: 80,
  ...
  //                                 ),
  //                                 onPressed: () {
  //                                   // Use setState to update the list and rebuild the UI
  //                                   setState(() {
